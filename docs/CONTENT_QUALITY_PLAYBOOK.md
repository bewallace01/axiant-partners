...
> **Key learning so far:** the worst-*scored* articles are actually substantive — the "AI sound" is a thin layer of stock phrases over good content. So the dominant fix is **surgical de-cliché**, not rewriting. Reserve full content/keyword rebuilds for pages that are genuinely thin or off-target (verify by reading, not by score alone).
